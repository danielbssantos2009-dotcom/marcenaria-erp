          ...
          <div className="bg-white/80 backdrop-blur-2xl border border-white/60 rounded-[32px] p-8 w-full max-w-md shadow-[0_20px_80px_-15px_rgba(0,0,0,0.3)] animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <select name="type" className="w-full border-0 bg-white/60 shadow-sm p-3.5 text-[15px] font-medium text-zinc-900 rounded-xl outline-none focus:ring-2 focus:ring-zinc-900/10 focus:bg-white transition-all">
              ...
              <div>
                ...
                <input required type="text" name="description" placeholder="Ex: Compra de material" className="w-full border-0 bg-white/60 shadow-sm p-3.5 text-[15px] font-medium text-zinc-900 rounded-xl outline-none focus:ring-2 focus:ring-zinc-900/10 focus:bg-white transition-all" />
              </div>
              <div>
                <label className="block text-[13px] font-semibold text-zinc-500 mb-2">Valor (R$)</label>
                <input required type="number" step="0.01" name="value" placeholder="0.00" className="w-full border-0 bg-white/60 shadow-sm p-3.5 text-[15px] font-medium text-zinc-900 rounded-xl outline-none focus:ring-2 focus:ring-zinc-900/10 focus:bg-white transition-all" />
              </div>
